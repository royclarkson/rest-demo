...
import com.royclarkson.devnexus.pizzashop.domain.Pizza;
...
public class PizzaController {
	...
	public @ResponseBody Pizza createFromJson(@Valid Pizza pizza) {
		pizza.persist();
	...
	public @ResponseBody Pizza updateJson(@Valid Pizza pizza) {
		pizza.merge();
		return Pizza.findPizza(pizza.getId());
	}
