...
//
//
//  SSCreateBaseViewController.m
//  PizzaShop
//
//  Created by Roy Clarkson on 2/13/13.
//
...
@interface SSCreateBaseViewController ()
...
@implementation SSCreateBaseViewController
...
{
    SSBase *base = [[SSBase alloc] initWithName:self.textName.text];
    
    NSURL *url = [SSConnectionSettings urlWithFormat:@"/bases"];
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
    NSData *postData = [NSJSONSerialization dataWithJSONObject:[base dictionaryValue] options:0 error:nil];
...
- (void)viewDidLoad
{
    ...
    self.navigationBar.topItem.title = @"Create Base";
